...
RSpec.describe "CurrentWeather object" do
  let!(:attributes) {
    {datetime: DateTime.new(2020, 9, 30, 13, 27, 0o3, Rational(-6, 24)),
     sunrise: DateTime.new(2020, 9, 30, 6, 27, 0o3, Rational(-6, 24)),
     sunset: DateTime.new(2020, 9, 30, 18, 27, 0o3, Rational(-6, 24)),
     temperature: 85.6,
     feels_like: 95.6,
     humidity: 84,
     uvi: 0.12,
